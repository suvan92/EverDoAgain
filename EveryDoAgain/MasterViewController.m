...
static NSString * const createNewSegueIdentifier = @"createNewToDo";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self configureCell:cell withToDoItem:ToDoItem];
    return cell;
}
...
- (NSFetchedResultsController<ToDoItem *> *)fetchedResultsController
{
    ...
    NSFetchedResultsController<ToDoItem *> *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Master"];
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:[tableView cellForRowAtIndexPath:indexPath] withToDoItem:anObject];
            break;
